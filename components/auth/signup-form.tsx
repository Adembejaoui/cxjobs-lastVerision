      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <div className="flex gap-4 mt-2">
            <div className={`flex items-center gap-1 text-xs ${passwordRequirements.minLength ? 'text-green-600' : 'text-red-500'}`}>
            ...
            <div className={`flex items-center gap-1 text-xs ${passwordRequirements.uppercase ? 'text-green-600' : 'text-red-500'}`}>
              <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className={`flex items-center gap-1 text-xs ${passwordRequirements.lowercase ? 'text-green-600' : 'text-red-500'}`}>
              <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className={`flex items-center gap-1 text-xs ${passwordRequirements.number ? 'text-green-600' : 'text-red-500'}`}>
              <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
